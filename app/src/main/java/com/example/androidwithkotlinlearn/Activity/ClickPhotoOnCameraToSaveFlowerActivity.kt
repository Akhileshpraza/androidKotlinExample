...
class ClickPhotoOnCameraToSaveFlowerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_click_photo_on_camera_to_save_flower)

        imageView = findViewById(R.id.imageView)
        button = findViewById(R.id.btnCaptureImage)
        val BtnView = findViewById<Button>(R.id.btnviewimage)

        BtnView.setOnClickListener {
            startActivity(Intent(this@ClickPhotoOnCameraToSaveFlowerActivity, ImageViewsActivity::class.java))
        }
                ...
                try {
                    ...
                    if (photoFile != null) {
                        ...
                        var photoURI = FileProvider.getUriForFile(this,
                            "com.example.androidwithkotlinlearn",
                            photoFile!!
                        )
